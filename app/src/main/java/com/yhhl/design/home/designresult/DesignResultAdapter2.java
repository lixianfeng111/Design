...
public class DesignResultAdapter2 extends CommonBaseAdapter<String> {

    private Context context;
    private boolean isFirst;
    private int n;
    public DesignResultAdapter2(Context context, List<String> datas, boolean isOpenLoadMore) {
...
//                }
    ...
    protected int getItemLayoutId() {
        return R.layout.design_result_item2;
    }
