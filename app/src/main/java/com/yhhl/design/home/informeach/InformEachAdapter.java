...
public class InformEachAdapter extends CommonBaseAdapter<String> {
    private Context context;
    public InformEachAdapter(Context context, List<String> datas, boolean isOpenLoadMore) {
    ...
    protected int getItemLayoutId() {
        return R.layout.inform_each_item;
    }
