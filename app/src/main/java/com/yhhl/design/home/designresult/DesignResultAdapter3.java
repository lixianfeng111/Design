...
public class DesignResultAdapter3 extends CommonBaseAdapter<String> {

    private Context context;
    private boolean isFirst;
    private int n;
    public DesignResultAdapter3(Context context, List<String> datas, boolean isOpenLoadMore) {
