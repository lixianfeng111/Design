package com.yhhl.design.home.openinformation;
...
public class OpenInformationFragment extends BaseFragment {
    @BindView(R.id.title)
    TextView title;
    ...
    public int initLayoutId() {
        return R.layout.fragment_open_information;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back:
                EventBus.getDefault().post(new DismissEvent(new OpenInformationFragment()));
                break;
        }
    }
