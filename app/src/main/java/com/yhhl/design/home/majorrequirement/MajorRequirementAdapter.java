...
public class MajorRequirementAdapter extends CommonBaseAdapter<String> {
    private Context context;
    public MajorRequirementAdapter(Context context, List<String> datas, boolean isOpenLoadMore) {
    ...
    protected int getItemLayoutId() {
        return R.layout.major_requirement_item;
    }
